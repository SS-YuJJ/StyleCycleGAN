...
from models.stylegan2.version import __version__
from models.stylegan2.diff_augment import DiffAugment
...
class Trainer():
    def __init__(
        ...
        **kwargs
        ...
        # self.wandb_run = wandb.init(project='styleGAN2_male2female') if not wandb.run else wandb.run
    ...
    def train(self):
        ...
        for i in gradient_accumulate_contexts(
            ...
            if apply_gradient_penalty:
                ...
                # wandb.log({"GP_loss": self.last_gp_loss})
        ...
        if apply_path_penalty and not np.isnan(avg_pl_length):
            ...
            # wandb.log({"PL_mean": self.pl_mean})
