...
#     img_folder_dir = os.path.join(folder_dir, f"innerCLIP_lr=5e-6_layer_{layer_num}")
...
#     target_folder = "./imgs/innerCLIP_loss_lr=5e-6[all]/"
#     checkPath(target_folder)
#     target_img_path = os.path.join(target_folder, f"innerCLIP_loss_lr=5e-6_layer_{layer_num}.jpg")
...
target_folder = "./imgs/innerCLIP_loss_lr=5e-6[all]/"
checkPath(target_folder)
target_img_path = os.path.join(target_folder, f"innerCLIP_loss_lr=5e-6_layer_LastEpoch_1-12Layer.jpg")
trans = transforms.ToTensor()
